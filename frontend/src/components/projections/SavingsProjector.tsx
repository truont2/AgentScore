        ...
        <div className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="flex items-center gap-2">
                    ...
                    <h2 className="text-sm font-medium text-foreground">Projected Savings</h2>
                </div>
            ...
            {/* The Green Box (Hero) */}
            <div className="bg-emerald-950/40 border border-emerald-500/30 rounded-lg p-4 sm:px-6 sm:py-5 flex flex-col sm:flex-row sm:items-center gap-4 relative overflow-hidden group transition-all hover:border-emerald-500/50">
            ...
            {savingsPerRun > 0 && (
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-2">
                    ...
                    <div className="bg-card border border-border/50 rounded-lg p-3 text-center border-emerald-500/20 bg-emerald-500/5">
